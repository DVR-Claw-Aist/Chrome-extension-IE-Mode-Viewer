...
**Удаление** — как у любого приложения: *Параметры → Приложения → IE Mode Viewer → Удалить*, или правый клик по иконке в трее → **Uninstall**. Просмотрщик, ярлык и настройки удаляются.
